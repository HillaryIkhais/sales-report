...
- **Feature engineering**: Creating new columns (Revenue, date components) from existing data
- **Pandas**: GroupBy operations, aggregations, and data manipulation
- **Matplotlib**: Creating meaningful visualizations
